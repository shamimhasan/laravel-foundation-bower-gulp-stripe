    ...
    <div class="row">
        <div class="large-3 columns">
            <div class="panel">
                ...
                <p>
                    This is a three columns grid panel with an arbitrary
                    height.
                </p>
            </div>
        </div>
        <div class="large-6 columns">
            <div class="panel">
                ...
                <p>
                    This is a six columns grid panel with an arbitrary
                    height. Bacon ipsum dolor sit amet salami ham hock
                    biltong ball tip drumstick sirloin pancetta meatball
                    short loin.
                </p>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="large-4 columns">
            <div class="panel">
                ...
                <p>
                    This is a four columns grid panel with an arbitrary
                    height. Bacon ipsum dolor sit amet salami.
                </p>
            </div>
        </div>
    </div>
